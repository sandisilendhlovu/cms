 ...
 * @param object $conn connection to the database
 * @param integar $limit Number of records to return 
 * @param integar $offset Number of records to skip
 * 
 * @param array An associative array of the page of article records
 * 
 */
 ...
 * 
 * @param object $conn connection to the database
 * @param integer $id the artitle ID
...
public static function getByID($conn, $id, $columns = '*')
{
     ...
     * 
     * @param object $conn Connection to the database
     * @param integar $id the article ID
     * 
 ...
 * 
 * @param object $conn Connection to the database
 * @param boolean True if the delete was successful, false otherwise
 * 
 */
...
public function delete($conn)
 ...
 /**
  * Insert new article with its current property values
  * @param object $conn Connection to the database 
